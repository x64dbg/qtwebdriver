...
bool CommandRoutes::IsStandardRoute(const std::string& pattern) {
	...
	if (standardCommandRoutes.empty()) {
		...
		standardCommandRoutes.insert(kGetWindowHandlesW3C);
		...
		standardCommandRoutes.insert(kExecuteScriptW3C);
		standardCommandRoutes.insert(kExecuteAsyncScript);
		standardCommandRoutes.insert(kExecuteAsyncScriptW3C);
		...
		standardCommandRoutes.insert(kAlertTextW3C);
		standardCommandRoutes.insert(kAcceptAlert);
		standardCommandRoutes.insert(kAcceptAlertW3C);
		standardCommandRoutes.insert(kDismissAlert);
		standardCommandRoutes.insert(kDismissAlertW3C);
		standardCommandRoutes.insert(kMaximizeWindowW3C);
...
const char CommandRoutes::kGetWindowHandlesW3C[] 		= "/session/*/window/handles";
...
const char CommandRoutes::kExecuteScriptW3C[] 			= "/session/*/execute/sync";
const char CommandRoutes::kExecuteAsyncScript[] 		= "/session/*/execute_async";
const char CommandRoutes::kExecuteAsyncScriptW3C[] 		= "/session/*/execute/async";
...
const char CommandRoutes::kAlertTextW3C[] 				= "/session/*/alert/text";
const char CommandRoutes::kAcceptAlert[] 				= "/session/*/accept_alert";
const char CommandRoutes::kAcceptAlertW3C[] 			= "/session/*/alert/accept";
const char CommandRoutes::kDismissAlert[] 				= "/session/*/dismiss_alert";
const char CommandRoutes::kDismissAlertW3C[] 			= "/session/*/alert/dismiss";
const char CommandRoutes::kMaximizeWindowW3C[] 			= "/session/*/window/maximize";
