...
DefaultRouteTable::DefaultRouteTable() 
    ...
    Add<WindowHandlesCommand>           (CommandRoutes::kGetWindowHandlesW3C);
    ...
    Add<ExecuteCommand>                 (CommandRoutes::kExecuteScriptW3C);
    Add<ExecuteAsyncScriptCommand>      (CommandRoutes::kExecuteAsyncScript);
    Add<ExecuteAsyncScriptCommand>      (CommandRoutes::kExecuteAsyncScriptW3C);
    ...
    Add<AlertTextCommand>               (CommandRoutes::kAlertTextW3C);
    Add<AcceptAlertCommand>             (CommandRoutes::kAcceptAlert);
    Add<AcceptAlertCommand>             (CommandRoutes::kAcceptAlertW3C);
    Add<DismissAlertCommand>            (CommandRoutes::kDismissAlert);
    Add<DismissAlertCommand>            (CommandRoutes::kDismissAlertW3C);
    Add<WindowMaximizeCommand>          (CommandRoutes::kMaximizeWindowW3C);
